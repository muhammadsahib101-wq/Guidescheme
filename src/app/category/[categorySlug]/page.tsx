...
function CategorySchemesContent() {
	...
	return (
		<>
			<Head>
				...
				<meta
					name="keywords"
					content={`government schemes, ${categoryName}, welfare programs, benefits, eligibility`}
				/>
				...
				<meta
					...
					content={`Explore government schemes for ${categoryName}.`}
				/>
